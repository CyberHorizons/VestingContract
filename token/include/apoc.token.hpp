...
namespace eosio {
   ...
   class [[eosio::contract("apoc.token")]] token : public contract {
      public:
         const string INVESTOR_CONTRACT = "y4tn4dotcdot";
         const string STAKING_CONTRACT = "noname";
         ...
         [[eosio::action]]
         void bloktransfer( const bool& block);
         /**
          * Open action.
          *
         ...
         */
         ...
         using block_action = eosio::action_wrapper<"bloktransfer"_n, &token::bloktransfer>;
      private:
         ...
         struct [[eosio::table]] block {
            ...
            uint64_t primary_key()const { return blocked; }
         };
